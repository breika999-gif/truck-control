...
// ── Shared base for circular neon-glow buttons ───────────────────────────────
// Spread this into StyleSheet entries that share the same neon-border+shadow
// pattern. Override only the fields that differ (size, elevation, opacity...).
export const baseNeonBtn = {
  width: 44,
  height: 44,
  borderRadius: 50,
...
export const styles = StyleSheet.create({
  ...
  navDistText: { fontWeight: '800', color: '#ffffff', lineHeight: 32 },
  ...
  pkWebBtnTxt: { color: NEON, fontWeight: '700', fontSize: 11 },
  parkingBubbleTtsBtn: {
    width: 36,
    height: 36,
    borderRadius: 8,
